...
//        [expandedIndexPaths addObject:[NSIndexPath indexPathForRow:0 inSection:0]];
//        actionToTake = 1;
...
- (void)scrollViewDidScroll:(UIScrollView *)scrollView {
    if ([HVTableViewDelegate respondsToSelector:@selector(scrollViewDidScroll:)]) {
        return [HVTableViewDelegate scrollViewDidScroll:scrollView];
    }
